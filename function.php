...
{
    global $from_id, $optionMarzban, $optionX_ui_single, $optionhiddfy, $option_candy, $optionalireza_single, $optionmarzneshin, $option_mikrotik, $optionwg, $options_ui, $optionibsng;
